...
if TYPE_CHECKING:
    from helios.extensibility import (  # noqa: F401
        BasePlugin,
    )
...
class BaseEvent:
    ...
    events. The startup of Helios itself can be an event as well as the start of a plugin itself
    which, for instance, gives other plugins the chance to start based on these previous events.
    """
    pass


class HeliosStartupEvent(BaseEvent):
    """
    Broadcasted when Helios is starting.
    """
