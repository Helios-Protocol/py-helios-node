...
#REWARD_TYPE_2_AMOUNT_FACTOR = 0.03*1/(60*60*24*365) #3 % per year for normal nodes
REWARD_TYPE_2_AMOUNT_FACTOR = 0.1*1/(60*60*24*365) #3 % per year for normal nodes
...
MASTERNODE_LEVEL_1_REWARD_TYPE_2_MULTIPLIER = 4/3 #4 % per year
MASTERNODE_LEVEL_2_REWARD_TYPE_2_MULTIPLIER = 6/3 #6 % per year
MASTERNODE_LEVEL_3_REWARD_TYPE_2_MULTIPLIER = 8/3 #8 % per year

EARLY_BIRD_BONUS_FACTOR = 8 #8 x rewards for the first year
