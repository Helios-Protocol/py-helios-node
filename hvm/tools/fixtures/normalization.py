...
def normalize_transactiontest_fixture(fixture, fork):
    ...
    try:
        normalized_fixture['rlp_templates'] = decode_hex(fixture['rlp_templates'])
    except binascii.Error:
        normalized_fixture['rlpHex'] = fixture['rlp_templates']
...
def normalize_block(block):
    ...
    try:
        normalized_block['rlp_templates'] = decode_hex(block['rlp_templates'])
