...
def test_child_transaction_from_call_opcode():
    ...
    code = assemble(
                ...
                RECEIVER.public_key.to_canonical_address(), # to
                opcode_values.PUSH32,
    ...
    print(receiver_block.transactions[0].as_dict())


test_child_transaction_from_call_opcode()