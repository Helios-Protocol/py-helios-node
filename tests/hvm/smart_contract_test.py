...
def _test_airdrop_calling_erc_20():
    ...
    genesis_params, genesis_state = create_new_genesis_params_and_state(GENESIS_PRIVATE_KEY, 1000000*10**18, int(time.time())-coin_mature_time*10000)

    # import genesis block
    chain = MainnetChain.from_genesis(testdb, GENESIS_PRIVATE_KEY.public_key.to_canonical_address(), genesis_params, genesis_state, GENESIS_PRIVATE_KEY)
